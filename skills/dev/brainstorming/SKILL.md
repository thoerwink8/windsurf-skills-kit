---
name: brainstorming
description: "Socratic design refinement: turn ideas into fully formed designs and specs through collaborative dialogue. Source: obra/superpowers"
---
...
Explore project context
  → Visual questions ahead? → [yes] Offer Visual Companion (own message) → Ask clarifying questions
                            → [no]  Ask clarifying questions
  → Propose 2-3 approaches
  → Present design sections
  → User approves? → [no] revise → Present design sections
                   → [yes] Write design doc
  → Spec self-review (fix inline)
  → User reviews spec? → [changes] Write design doc
