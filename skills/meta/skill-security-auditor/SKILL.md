...
description: "Audit AI agent skills for security risks before installation (code injection, prompt injection, supply chain). Source: alirezarezvani/claude-skills"
---
